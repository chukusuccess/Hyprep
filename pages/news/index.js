  ...
  return (
    <MainLayout>
      <div>
        ...
        <section className="sm:py-20 sm:px-[140px] pb-10 py-10 px-[30px] w-full bg-white flex flex-col items-center">
...
"
        ...
        <section className="sm:py-20 sm:px-20 py-10 px-[30px] w-full bg-backgroundPrimary flex flex-col text-black">
          <div className="text-left">
