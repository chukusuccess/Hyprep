      ...
      <MainLayout>
        <div className="w-full pt-12">
          ...
          <section className="sm:py-20 sm:px-[140px] py-10 px-[30px] w-full bg-white flex flex-col items-center">
            <div className="sm:h-[663px] h-[331px] w-full flex flex-row-reverse sm:gap-[35px] gap-[17px]">
          ...
          <section className="sm:py-20 sm:px-[140px] py-10 px-[30px] w-full bg-white flex flex-col text-black">
            <p className="text-justify mb-10">
              ...
              adipiscing non. Venenatis, massa id tempus, fermentum, ut. Aliquam
              nulla convallis tellus velit rhoncus morbi massa. Nec interdum
              maecenas lectus fermentum semper a nunc bibendum. Aenean neque
              egestas et egestas sit tempus. Massa nisi, rhoncus in non commodo
              consectetur etiam nulla maecenas. Vitae ornare massa gravida et
              sit sit arcu duis. Luctus sed amet sit sed nisl. Odio nam amet,
              sagittis, sed sapien, lorem sit. Porta ac varius augue gravida
              neque. Vestibulum, scelerisque nunc, hac massa, porttitor aliquam
              pellentesque amet. Ornare nulla fermentum, viverra sit erat
              accumsan arcu. Viverra cursus velit, euismod justo, eu nulla. Cras
              nunc duis cursus non vitae mattis dictumst porttitor nulla. Dolor
              commodo sed venenatis sit neque nisl odio vestibulum amet. Cras
              lobortis purus egestas tortor purus laoreet sed scelerisque.
              Volutpat neque erat vestibulum lectus tincidunt est justo. Libero
              at in morbi tellus convallis. Tincidunt non at ultricies luctus
              pharetra. Cras malesuada enim, risus eu. Tristique ut purus
              sodales amet. Sodales fermentum ultricies dictumst nunc aliquam
              imperdiet venenatis tempor, lectus. Ac pretium, praesent
              suspendisse sit orci nullam tortor nulla. Quis arcu est facilisis
              ut sed felis. Ac dictum auctor tristique leo sapien commodo. Quis
              amet scelerisque leo, sed urna ullamcorper velit cursus. In eget
              porttitor donec vitae, ullamcorper pellentesque morbi feugiat
              faucibus. Sit viverra vitae tellus nunc commodo, lectus.
            </p>
          </section>
